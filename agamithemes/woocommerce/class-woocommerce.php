...
if ( ! class_exists( 'agami_shop_WooCommerce' ) ) :

	/**
	 * The Agami Shop WooCommerce Integration class
	 */
	class agami_shop_WooCommerce {
		...
		public function products_per_page() {
			return intval( apply_filters( 'agami_shop_filter_products_per_page', 12 ) );
		}
...
return new agami_shop_WooCommerce();