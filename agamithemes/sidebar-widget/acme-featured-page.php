 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'agami_shop_Featured_Page' ) ) {

    class agami_shop_Featured_Page extends WP_Widget {
        ...
        private function defaults(){
            ...
            $defaults = array(
                ...
                'first_page_id'      => '',
                'first_button_text'  => esc_html__( 'Shop Now', 'agami-shop' ),
                'first_button_url'   => '',
                'second_page_id'     => '',
                'second_button_text' => esc_html__( 'Shop Now', 'agami-shop' ),
                'second_button_url'  => ''
            );
            return $defaults;
        }
        ...
        function __construct() {
            ...
            /*Base ID of your widget*/
                ...
                esc_html__('AT Featured Section', 'agami-shop'),
                /*Widget description*/
                array( 'description' => esc_html__( 'Select page and Show title, featured image and excerpt', 'agami-shop' ), )
            );
        }
        ...
        public function form( $instance ) {
            ...
            <div class="feature-first-promo">
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'first_page_id' ) ); ?>"><?php esc_html_e( 'Select First Feature Page', 'agami-shop' ); ?></label>
                    <br />
                    <small><?php esc_html_e( 'Select a Page which have featured image and excerpts.', 'agami-shop' ); ?></small>
		            <?php
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'first_button_text' ) ); ?>"><?php esc_html_e( 'First Button Text', 'agami-shop' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'first_button_url' ) ); ?>"><?php esc_html_e( 'First Button Url', 'agami-shop' ); ?></label>
            ...
            <div class="feature-second-promo">
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'second_page_id' ) ); ?>"><?php esc_html_e( 'Select Second Feature Page', 'agami-shop' ); ?></label>
                    <br />
                    <small><?php esc_html_e( 'Select a Page which have featured image and excerpts.', 'agami-shop' ); ?></small>
			        <?php
			        /* see more here https://codex.wordpress.org/Function_Reference/wp_dropdown_pages*/
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'second_button_text' ) ); ?>"><?php esc_html_e( 'Second Button Text', 'agami-shop' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'second_button_url' ) ); ?>"><?php esc_html_e( 'Second Button Url', 'agami-shop' ); ?></label>
        ...
        public function widget($args, $instance) {
            ...
            <div class="featured-entries-col featured-entries-page">
		        ...
		        if( !empty( $post_in )) :
			        ...
			        $total_post = $agami_shop_featured_query->post_count;
			        ...
			        while ( $agami_shop_featured_query->have_posts() ) :$agami_shop_featured_query->the_post();
				        $agami_shop_list_classes .= " index-".absint( $agami_shop_featured_index );
				        ...
				        ?>
                        <div class="feature-promo <?php echo esc_attr( $agami_shop_list_classes ); ?>">
                            <div class="no-media-query single-unit" style="<?php echo esc_attr( $bg_image_style ); ?>">
                                <div class="page-details">
	                                ...
	                                <?php
	                                if( 1 == $agami_shop_featured_index ){
	                                ...
	                                if( 2 == $agami_shop_featured_index ){
    ...
    } // Class agami_shop_Featured_Page ends here
}