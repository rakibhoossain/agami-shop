 ...
 */
if ( ! function_exists( 'agami_shop_sanitize_social_data' ) ) :
	function agami_shop_sanitize_social_data( $input ){
		...
		if( !empty( $input_decoded ) ) {
			foreach ( $input_decoded as $boxes => $box ){
				foreach ( $box as $key => $value ){
                    ...
                    elseif ( $key == 'checkbox' ){
						$input_decoded[$boxes][$key] = agami_shop_sanitize_checkbox( $value );
					}
					else{
...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'agami_shop_Customize_Icons_Control' )):
	/**
	...
	class agami_shop_Customize_Icons_Control extends WP_Customize_Control {
            ...
            <label>
                ...
                <span class="at-customize-icons">
                    ...
                    <span class="icon-toggle">
                        <?php echo ( empty( $value )? esc_html__('Add Icon','agami-shop'): esc_html__('Edit Icon','agami-shop') ); ?>
                        <span class="dashicons dashicons-arrow-down"></span>
                    </span>
                    <span class="icons-list-wrapper hidden">
                        <input class="icon-search" type="text" placeholder="<?php esc_attr_e('Search Icon','agami-shop')?>">
	                    <?php
...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'agami_shop_Repeater_Control' )):
	/**
	 ...
	 *
	 */
	class agami_shop_Repeater_Control extends WP_Customize_Control {
		/**
		 * The control type.
		 *
		 * @access public
		...
		public function enqueue(){
			...
			wp_enqueue_style( 'agami-shop-customizer-repeater-style', get_template_directory_uri() . '/agamithemes/customizer/customizer-repeater/customizer-repeater.css', array(), '3.3.6' );
			wp_enqueue_script( 'agami-shop-customizer-repeater-script', get_template_directory_uri() . '/agamithemes/customizer/customizer-repeater/customizer-repeater.js', array('jquery', 'jquery-ui-draggable' ), '1.0.0', true  );
		}
                    ...
                    <div class="repeater-fields hidden">
								...
								switch ( $field['type'] ) {
									...
									case 'icons':
                                        ...
                                        <span class="at-customize-icons">
                                            ...
                                            <span class="icon-toggle">
                                                <?php esc_html_e('Add Icon','agami-shop'); ?>
                                                <span class="dashicons dashicons-arrow-down"></span>
                                            </span>
                                            <span class="icons-list-wrapper hidden">
                                                <input class="icon-search" type="text" placeholder="<?php esc_attr_e('Search Icon','agami-shop'); ?>">
                        ...
                        <div class="clearfix repeater-footer">
                            <a class="repeater-field-remove" href="#remove">
								<?php esc_html_e( 'Delete', 'agami-shop' ) ?>
                            </a>
                            <?php esc_html_e( '|', 'agami-shop' ) ?>
                            <a class="repeater-field-close" href="#close">
								<?php esc_html_e( 'Close', 'agami-shop' ) ?>
                            </a>
                        </div>
                    </div>
                </li>
									...
									switch ( $field['type'] ) {
										...
										case 'icons':
                                            ...
                                            <span class="at-customize-icons">
                                                ...
                                                <span class="icon-toggle">
                                                    <?php echo ( empty( $new_value )? esc_html__('Add Icon','agami-shop'): esc_html__('Edit Icon','agami-shop') ); ?>
                                                    <span class="dashicons dashicons-arrow-down"></span>
                                                </span>
                                                <span class="icons-list-wrapper hidden">
                                                    <input class="icon-search" type="text" placeholder="<?php esc_attr_e('Search Icon','agami-shop')?>">
