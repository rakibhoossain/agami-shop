...
$wp_customize->add_panel( 'agami-shop-feature-panel', array(
    'priority'      => 70,
    'capability'    => 'edit_theme_options',
    'title'         => esc_html__( 'Featured Section Options', 'agami-shop' ),
...
*/
require_once agami_shop_file_directory('agamithemes/customizer/feature-section/feature-left-section.php');

/*
* file for feature right section
*/
require_once agami_shop_file_directory('agamithemes/customizer/feature-section/feature-right-section.php');

/*
* file for special menu
*/
require_once agami_shop_file_directory('agamithemes/customizer/feature-section/special-menu.php');