...
jQuery(document).ready(function($) {
    ...
    $('.header-wrapper .agamithemes-nav').slicknav({
    ...
    $('.agamithemes-nav >ul > li,.special-menu-wrapper > li').each(function () {
    ...
    at_window.scroll(function(){
        if ( $(this).scrollTop() > menu_sticky_height) {
            $('.agami-shop-enable-sticky-menu').css({"position": "fixed", "top": "0","right": "0","left": "0","z-index":'999'});
            $('.agami-shop-enable-sticky-menu .header-main-menu').css('margin','0 auto');
        }
        else {
            $('.agami-shop-enable-sticky-menu').removeAttr( 'style' );
            $('.agami-shop-enable-sticky-menu .header-main-menu').removeAttr( 'style' );
        }
        if ( $(this).scrollTop() > menu_sticky_height) {
    ...
    at_window.on('load', function() {
        ...
        function feature_special_menu_height_fixed() {
            ...
            if( width > 992 ){
                var slider_height = $('.agami-shop-feature-special-menu .slider-feature-wrap').height();
                $('.agami-shop-feature-special-menu .special-menu-wrapper > li > ul').height( slider_height+19 );
            }
            else{
                $('.agami-shop-feature-special-menu .special-menu-wrapper > li > ul').attr('style','');
            }
        }
        ...
        function cats_tab() {
            ...
            at_body.on('click','.at-tabs > span', function(e){
                ...
                var $this = $(this),
                    tab_wrap = $this.closest('.widget_agami_shop_wc_cats_tabs'),
            ...
            $('.widget_agami_shop_wc_cats_tabs').each(function () {
